...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public boolean add(EmployeeDO employeeDO) {
		try {
			...
			String sql = "INSERT INTO employee (name, email, address, age, sex, dob) VALUES" + " ('"
					+ employeeDO.getName() + "', '" + employeeDO.getEmail() + "', '" + employeeDO.getAddress() + "', '"
					+ employeeDO.getAge() + "', '" + employeeDO.getSex() + "', '" + employeeDO.getDob() + "') ";
	...
	public boolean update(EmployeeDO employeeDO) {
		try {
			// @formatter:off
			String sql = "UPDATE employee SET " + "name = '" + employeeDO.getName() + "', email = '"
					+ employeeDO.getEmail() + "', address = '" + employeeDO.getAddress() + "', age = '"
					+ employeeDO.getAge() + "', sex = '" + employeeDO.getSex() + "', dob = '" + employeeDO.getDob()
					+ "' WHERE id = " + employeeDO.getId();
