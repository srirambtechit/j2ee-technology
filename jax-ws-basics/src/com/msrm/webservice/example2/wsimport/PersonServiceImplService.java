 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://example2.webservice.msrm.com/", wsdlLocation = "http://localhost:8888/personWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://example2.webservice.msrm.com/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/personWS?wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://example2.webservice.msrm.com/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example2.webservice.msrm.com/", "PersonServiceImplPort"), PersonService.class, features);
    }
